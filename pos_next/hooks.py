		...
		"filters": [
			[
				...
				[
					...
					"Sales Invoice-posa_print_format",
					"Sales Invoice-posa_letter_head",
					"Item-custom_company",
					"Item-posa_commission_rate",
					...
					"POS Profile-posa_mpesa_quick_pay_section",
					"POS Profile-posa_mpesa_business_shortcode",
